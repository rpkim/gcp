  ...
  settings {
    ...
    ip_configuration {
        authorized_networks = {
            ...
            value = "${google_compute_instance.vm1.network_interface.0.access_config.0.assigned_nat_ip}/32"
            //value = "${google_compute_instance.vm1.network_interface.0.address}/32"
        }
        authorized_networks = {
            name = "${google_compute_instance.vm2.name}"
            value = "${google_compute_instance.vm2.network_interface.0.access_config.0.assigned_nat_ip}/32"
